...
# Himmelblau LBFGS-B neighbor computation (`compute_k_neighbor_lbfgsb.py`).
CHAIN_COUPLING_WEIGHT="10.0"
...
python run/test/task/himmelblau/compute_k_neighbor_lbfgsb.py \
