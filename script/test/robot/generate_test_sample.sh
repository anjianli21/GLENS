...
"parameter_original_raw_concat_64" "parameter_original_radius_original_raw_concat_64"
"parameter_original_radius_original_raw_concat_64")
...
embed_y_all_dim_list=(64 64 128 128)
auto_normalize_list=(False False False False)

cond_scale_list=(1.5 1.5 1.5 1.5)
downsample_condition_ratio_list=(1.0 1.0 1.0 1.0)
...
parameter_data_process_type_list=('original' 'original' 'original' 'original')
radius_data_process_type_list=('original' 'original' 'original' 'original')

data_x_process_type_list=('add_t_into_channel' 'add_t_into_channel' 'add_t_into_channel' 'add_t_into_channel')
radius_square_grad_data_process_type_list=('original' 'original' 'original' 'original')
...
solver_behavior_condition_y_parameter_dim_list=(6 6 6 6)
...
solver_behavior_k_to_use_list=(10 10 10 10)
