...
WANDB_API_KEY=""
WANDB_PROJECT_NAME="qp_constrained_generate_test_sample"

project_name="qp_constrained_generate_test_sample"
...
LOGS_DIR="/media/anjian/T9/project/solver_info_submission/logs/qp_constrained"
TEST_SAMPLE_DIRECTORY="/media/anjian/T9/project/solver_info_submission/test_sample_data/qp_constrained"
...
checkpoint_parent_dir_list=(
  "/media/anjian/T9/project/solver_info_submission/training_results/qp_constrained/qp_constrained_diffusion_experiment/qp_constrained_diffusolve_k_1"
  "/media/anjian/T9/project/solver_info_submission/training_results/qp_constrained/qp_constrained_diffusion_experiment/qp_constrained_diffusolve_k_10"
  "/media/anjian/T9/project/solver_info_submission/training_results/qp_constrained/qp_constrained_diffusion_experiment/qp_constrained_NS_k_10"
  "/media/anjian/T9/project/solver_info_submission/training_results/qp_constrained/qp_constrained_diffusion_experiment/qp_constrained_NS_k_10"
)

# One solver-behavior checkpoint parent dir per run (4 runs total)
solver_behavior_checkpoint_parent_dir_list=(
  "/media/anjian/T9/project/solver_info_submission/training_results/qp_constrained/qp_constrained_dynamics_experiment/qp_constrained_dynamics_k_10"
  "/media/anjian/T9/project/solver_info_submission/training_results/qp_constrained/qp_constrained_dynamics_experiment/qp_constrained_dynamics_k_10"
  "/media/anjian/T9/project/solver_info_submission/training_results/qp_constrained/qp_constrained_dynamics_experiment/qp_constrained_dynamics_k_10"
  "/media/anjian/T9/project/solver_info_submission/training_results/qp_constrained/qp_constrained_dynamics_experiment/qp_constrained_dynamics_k_10"
)
...
data_stat_file_path_list=(
  "/media/anjian/T9/project/solver_info_submission/data/qp_constrained/stat_qp_constrained_dim_100_k_1.pkl"
  "/media/anjian/T9/project/solver_info_submission/data/qp_constrained/stat_qp_constrained_dim_100_k_1.pkl"
  "/media/anjian/T9/project/solver_info_submission/data/qp_constrained/stat_qp_constrained_dim_100_k_10.pkl"
  "/media/anjian/T9/project/solver_info_submission/data/qp_constrained/stat_qp_constrained_dim_100_k_10.pkl"
)
