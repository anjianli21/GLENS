...
class HimmelblauDataset(BaseDataset):
    def __init__(self, 
                 logger=None,
                 split='train', 
                 args=None):
    ...
    def _prepare_condition_y(self, sol_hist_data, marjor_iter_idx):
        ...
        if 'parameter' in self.condition_encoder_data_type or 'parameter' in self.solver_behavior_data_type:
            ...
            if self.parameter_data_process_type == 'original':
                ...
                condition_y_parameter_concat = (condition_y_parameter_concat - self.parameter_data_min) / (self.parameter_data_max - self.parameter_data_min)
            else:
